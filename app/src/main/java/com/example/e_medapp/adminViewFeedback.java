...
public class adminViewFeedback extends AppCompatActivity implements AsyncResponse/*, AdapterView.OnItemClickListener */{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(adminViewFeedback.this, this);
    ...
    */
    ...
    public void processFinish(String s) {
        ...
        dict.addStringField(R.id.tvAdminPatientFeedbackID, new StringExtractor<adminPatient>() {
            @Override
            public String getStringValue(adminPatient item, int position) {
                return item.PatientID;
            }
        });
        dict.addStringField(R.id.tvAdminPatientFeedback, new StringExtractor<adminPatient>() {
            @Override
            public String getStringValue(adminPatient item, int position) {
      ...
      /*  dict.addStringField(R.id.tvAdminPatientTime, new StringExtractor<adminPatient>() {
        ...
        adapter = new FunDapter<>(
                adminViewFeedback.this, userList, R.layout.layout_admin_view_feedback, dict);
