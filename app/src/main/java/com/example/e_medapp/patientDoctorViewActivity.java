...
public class patientDoctorViewActivity extends AppCompatActivity implements AsyncResponse/*, AdapterView.OnItemClickListener */{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(patientDoctorViewActivity.this, this);
...
/*
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        Log.d(LOG, selectedDoctor.DoctorName);

        if(item.getItemId() == R.id.menuUpdate){
            Intent in = new Intent(patientDoctorViewActivity.this, adminDoctorDetailsActivity.class);
            ...
            alert.setMessage("Do you want to remove " + selectedDoctor.DoctorName + "?");
            alert.setPositiveButton("Remove", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    PostResponseAsyncTask taskUpdate = new PostResponseAsyncTask(patientDoctorViewActivity.this,
                            postData, new AsyncResponse() {
                        @Override
                        public void processFinish(String s) {
                            Log.d(LOG, s);
                            if(s.contains("success")){
                                Toast.makeText(patientDoctorViewActivity.this, "Delete Successfully", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
    ...
    public void processFinish(String s) {
      ...
      /*  dict.addStringField(R.id.tvAdminPatientTime, new StringExtractor<adminDoctor>() {
        ...
        adapter = new FunDapter<>(
                patientDoctorViewActivity.this, userList, R.layout.layout_admin_doctor_view, dict);
